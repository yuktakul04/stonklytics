...
export default function NewsModal({ isOpen, onClose, ticker, companyName }) {
    ...
    return (
        <div className="fixed inset-0 bg-black/80 backdrop-blur-sm z-50 flex items-center justify-center p-4">
            <div className="bg-dark-card border border-dark-border rounded-xl shadow-large max-w-4xl w-full max-h-[90vh] overflow-hidden flex flex-col animate-slide-up">
                {/* Header */}
                        ...
                        <div>
                            {newsData.length === 0 ? (
                                <div className="text-center py-12 text-gray-400">
                                    ...
                                    <p className="text-gray-400">No recent news articles found for {ticker}</p>
                                </div>
                            ) : (
                                <div className="space-y-6">
                                    {newsData.map((article, index) => (
                                        <div key={index} className="border border-dark-border rounded-lg p-6 bg-dark-surface hover:border-gray-600 transition-all duration-200">
                                            ...
                                            <div className="flex justify-between items-center">
                                                ...
                                                {article.article_url && (
                                                    <a
                                                        ...
                                                        className="inline-flex items-center px-4 py-2 bg-white text-dark-bg hover:bg-gray-200 text-sm font-medium rounded-lg transition-all duration-200"
                                                    >
